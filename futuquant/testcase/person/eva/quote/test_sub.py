...
class Sub(object):
    ...
    def test4(self):
        ...
        print(quote_ctx.subscribe(code_list = codes[:1000], subtype_list=SubType.QUOTE))
        print(quote_ctx.query_subscription())
        quote_ctx.close()
    ...
    def test5(self):
        ...
        #,SubType.K_1M,SubType.K_5M,SubType.K_15M, SubType.K_30M, SubType.K_60M,SubType.K_DAY, SubType.K_WEEK, SubType.K_MON
