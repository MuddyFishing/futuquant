...
_C2S = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='filterStatus', full_name='Trd_GetOrderList.C2S.filterStatus', index=2,
