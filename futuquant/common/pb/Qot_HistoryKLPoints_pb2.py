...
_C2S = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='maxReqStockNum', full_name='Qot_HistoryKLPoints.C2S.maxReqStockNum', index=5,
