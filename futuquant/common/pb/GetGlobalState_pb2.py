...
_S2C = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='lastLocalSvrTimeDiff', full_name='GetGlobalState.S2C.lastLocalSvrTimeDiff', index=11,
