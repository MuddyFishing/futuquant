...
import futuquant.common.pb.Common_pb2 as Common__pb2
import futuquant.common.pb.Qot_Common_pb2 as Qot__Common__pb2
...
_C2S = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='isRegPush', full_name='Qot_Sub.C2S.isRegPush', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='isUnRegPush', full_name='Qot_Sub.C2S.isUnRegPush', index=4,
