...
class ProtobufMap(dict):
    ...
    def __init__(self):
        ...
        from futuquant.common.pb.GetGlobalState_pb2 import Response
        ...
        from futuquant.common.pb.Qot_GetSecuritySnapshot_pb2 import Response
        ProtobufMap.created_protobuf_map[ProtoId.Qot_GetSecuritySnapshot] = Response()

        """ Qot_GetPlateSet = 3204  # 获取板块集合下的板块 """
        from futuquant.common.pb.Qot_GetPlateSet_pb2 import Response
        ...
        """ Qot_GetOwnerPlate = 3210 获取资金流"""
        from futuquant.common.pb.Qot_GetCapitalFlow_pb2 import Response
        ProtobufMap.created_protobuf_map[ProtoId.Qot_GetCapitalFlow] = Response()

        """ Qot_GetOwnerPlate = 3210 获取资金分布"""
        from futuquant.common.pb.Qot_GetCapitalDistribution_pb2 import Response
